...
// Matches the choose-access.tsx / select-manager.tsx / select-rep.tsx dark
// navy/orange theme (Carin, 2026-08-17: "work on all screens that don't
// have this new navy blue design").
...
export default function SelectClient() {
  ...
  const { accessMode, setAccessMode, setClientLocked, setSelectedClient } = useAccess();
    ...
    >
      ...
      <div style={{ width: "100%", maxWidth: 420, position: "relative" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 13.5, color: TEXT_MUTED, marginTop: 6 }}>Client Access</p>
        </div>
        ...
        <label style={{ fontSize: 12, fontWeight: 700, color: TEXT_MUTED, letterSpacing: "0.04em", textTransform: "uppercase", marginBottom: 10, display: "block" }}>
          Select Your Client <span style={{ color: ORANGE }}>*</span>
        </label>
        <SearchableSelect
          value={clientValue}
        ...
        <button
          ...
          style={{
            ...
            height: 48,
            marginTop: 20,
            backgroundColor: clientValue ? ORANGE : "rgba(23,68,111,0.4)",
            color: clientValue ? "#FFFFFF" : TEXT_MUTED,
            fontSize: 15,
            fontWeight: 700,
            borderRadius: 10,
            border: "none",
            cursor: clientValue ? "pointer" : "not-allowed",
          }}
        >
          CONTINUE
        </button>
